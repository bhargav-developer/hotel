...
const foodsound = new Audio("../project5/img/food.mp3")
const gameover = new Audio('../project5/img/gameover.mp3');
const movesound = new Audio("../project5/img/move.mp3");
let speed = 7;
...
function gameEngine() {
    ...
    if (isCollide(snakearr)) {
        gameover.play();
        inputdir = { x: 0, y: 0 };
        alert("Game Over. press any OK to restart !")
        snakearr = [{ x: 13, y: 15 }];
        score = 0;
